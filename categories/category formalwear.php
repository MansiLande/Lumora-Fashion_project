<?php
include '../db.php'; // go one folder up from categories/

$result = $conn->query("SELECT * FROM products where category='FormalWear'"); ?>
...
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <title>Category | FormalWear</title>
...
document.addEventListener("click", function(e) {
  ...
  if (!dropdown.contains(e.target)) {
    ...
    <section class="sub-nav">
      <a href="#">Category</a> | <a href="#">Formalwear</a> |
      <a href="#" id="current-category">Formal Shirts</a>
    </section>
    ...
    <section class="circle-section">
      <div class="circle-container">
        <div class="circle-item selected">
          <a href="#">
            <img
              src="category-images/formalwear-circle-images/circle-formalwear.jpg"
              alt="Formal Shirts"
            />
        ...
        <div class="circle-item selected">
          <a href="#">
            <img
              src="category-images/formalwear-circle-images/circle-trouser.jpg"
              alt="Formal Shirts"
            />
            <span>Trousers</span>
          </a>
        ...
        <div class="circle-item selected">
          <a href="#">
            <img
              src="category-images/formalwear-circle-images/circle-waistcoat.jpg"
              alt="Formal Shirts"
            />
        ...
        <div class="circle-item selected">
          <a href="#">
            <img
              src="category-images/formalwear-circle-images/circle-blazer.jpg"
              alt="Formal Shirts"
            />
            <span>Blazers</span>
          </a>
        ...
        <div class="circle-item selected">
          <a href="#">
            <img
              src="category-images/formalwear-circle-images/circle-cardigan.jpg"
              alt="Formal Shirts"
            />
            <span>Cardigans</span>
          </a>
