...
$result = $conn->query("SELECT * FROM products WHERE category='Handbags'");
?>
<?php
session_start();
...
document.addEventListener("click", function(e) {
  ...
  if (!dropdown.contains(e.target)) {
    ...
    <section class="sub-nav">
      ...
      <a href="#" id="current-category">Cluth Bags</a>
    </section>
    ...
    <section class="circle-section">
      <div class="circle-container">
        <div class="circle-item selected">
          <a href="#">
            <img
              src="category-images/bags-circle-images/clutchbag.jpg"
              alt="Tote Bags"
            />
        ...
        <div class="circle-item selected">
          <a href="#">
            <img
              src="category-images/bags-circle-images/satchalbag.jpg"
              alt="Satchel Bag"
            />
        ...
        <div class="circle-item selected">
          <a href="#">
            <img
              src="category-images/bags-circle-images/totebag.jpg"
              alt="Clutch Bag"
            />
            <span>Tote Bags</span>
          </a>
        ...
        <div class="circle-item selected">
          <a href="#">
            <img
              src="category-images/bags-circle-images/crossbodybag.jpg"
              alt="Crossbody Bag"
            />
        ...
        <div class="circle-item selected">
          <a href="#">
            <img
              src="category-images/bags-circle-images/backpackbag.jpg"
              alt="Backpack Bag"
            />
