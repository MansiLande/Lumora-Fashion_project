...
$result = $conn->query("SELECT * FROM products where category='Dresses'"); ?>
...
document.addEventListener("click", function(e) {
  ...
  if (!dropdown.contains(e.target)) {
    ...
    <section class="sub-nav">
      <a href="#">Category</a> | <a href="#">Dresses</a> |
      <a href="#" id="current-category">Bodycon Dress</a>
    </section>
    ...
    <section class="circle-section">
      <div class="circle-container">
        <div class="circle-item selected">
          <a href="#">
            <img
              src="category-images/dresses-circle-images/bodycondress.jpg"
              alt="Bodycon Dress"
            />
            <span>Bodycon Dress</span>
          </a>
        </div>
        ...
        <div class="circle-item selected">
          <a href="#">
            <img
              src="category-images/dresses-circle-images/jumpsuits.jpg"
              alt="Jumpsuits Dress"
            />
            <span>Jumpsuits</span>
          </a>
        ...
        <div class="circle-item selected">
          <a href="#">
            <img src="category-images/dresses-circle-images/maxidress.jpg"
              alt="Maxi Dress"
            />
        ...
        <div class="circle-item selected">
          <a href="#">
            <img
              src="category-images/dresses-circle-images/cocktaildress.jpg"
              alt="Cocktail Dress"
            />
        ...
        <div class="circle-item selected">
          <a href="#">
            <img
              src="category-images/dresses-circle-images/shirtdress.jpg"
              alt="Shirt Dress"
            />
