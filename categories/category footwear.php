...
$result = $conn->query("SELECT * FROM products WHERE category='FootWear'");
?>
<?php
session_start();
...
document.addEventListener("click", function(e) {
  ...
  if (!dropdown.contains(e.target)) {
    ...
    <section class="sub-nav">
      <a href="#">Category</a> | <a href="#">FootWear</a> |
      <a href="#" id="current-category">Heels</a>
    </section>
    ...
    <section class="circle-section">
      <div class="circle-container">
        <div class="circle-item selected">
          <a href="#">
            <img
              src="category-images/footwear-circle-images/heels.jpg"
              alt="Heels"
            />
            <span>Heels</span>
          </a>
        ...
        <div class="circle-item selected">
          <a href="#">
            <img
              src="category-images/footwear-circle-images/balletflat.jpg"
              alt="Balletflat Shoes"
            />
            <span>Balletflat Shoes</span>
          </a>
        </div>
        ...
        <div class="circle-item selected">
          <a href="#">
            <img
              src="category-images/footwear-circle-images/sneakers.jpg"
              alt="Sneakers"
            />
            <span>Sneakers</span>
          </a>
        ...
        <div class="circle-item selected">
          <a href="#">
            <img
              src="category-images/footwear-circle-images/sandals.jpg"
              alt="Sandals"
            />
            <span>Sandals</span>
          </a>
        ...
        <div class="circle-item selected">
          <a href="#">
            <img
              src="category-images/footwear-circle-images/ankleboots.jpg"
              alt="Ankle Boots"
            />
...
// fetch sandals (footwear category)
$result = $conn->query("SELECT * FROM products WHERE category = 'Footwear'");
?>
