...
$result = $conn->query("SELECT * FROM products WHERE category='Denim Dress'");
?>
<?php
session_start();
...
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <title>Category | Denim Fits</title>
...
document.addEventListener("click", function(e) {
  ...
  if (!dropdown.contains(e.target)) {
    ...
    <section class="sub-nav">
      ...
      <a href="#" id="current-category">Denim Dress</a>
    </section>
      ...
      <div class="circle-container">
        <div class="circle-item selected">
          <a href="#">
            <img
              src="category-images/denim-circle-images/dress.jpg"
              alt="Rings"
            />
        ...
        <div class="circle-item selected">
          <a href="#">
            <img
              src="category-images/denim-circle-images/jacket.jpg"
              alt="Necklace"
            />
      ...
      <div class="circle-item selected">
          <a href="#">
            <img
              src="category-images/denim-circle-images/jeans.jpg"
              alt="Bracelet"
            />
        ...
        <div class="circle-item selected">
          <a href="#">
            <img
              src="category-images/denim-circle-images/shirt.jpg"
              alt="Earrings"
            />
        ...
        <div class="circle-item selected">
          <a href="#">
            <img
              src="category-images/denim-circle-images/shorts.jpg"
              alt="Anklets"
            />
...
<section class="product-section">  
  <div class="product-grid">
    <?php 
    // Fetch Denim Dress products
    $denimProducts = $conn->query("SELECT * FROM products WHERE category='Denim Dress'");
    while ($row = $denimProducts->fetch_assoc()): ?>
