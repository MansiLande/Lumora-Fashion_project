...
$result = $conn->query("SELECT * FROM products WHERE category='Accesssories'");
?>
<?php
session_start();
...
document.addEventListener("click", function(e) {
  ...
  if (!dropdown.contains(e.target)) {
    ...
    <section class="sub-nav">
      <a href="#">Category</a> | <a href="#">Accessories</a> |
      <a href="#" id="current-category">Neck Chains</a>
    </section>
      ...
      <div class="circle-container">
        <div class="circle-item selected">
          <a href="#">
            <img
              src="category-images/accessories-circle-images/necklace.jpg"
              alt="Rings"
            />
        ...
        <div class="circle-item selected">
          <a href="#">
            <img
              src="category-images/accessories-circle-images/rings.jpg"
              alt="Necklace"
            />
            <span>Rings</span>
          </a>
      ...
      <div class="circle-item selected">
          <a href="#">
            <img
              src="category-images/accessories-circle-images/bracelet.jpg"
              alt="Bracelet"
            />
            <span>Bracelet</span>
          </a>
        ...
        <div class="circle-item selected">
          <a href="#">
            <img
              src="category-images/accessories-circle-images/earring.jpg"
              alt="Earrings"
            />
            <span>Earrings</span>
          </a>
        ...
        <div class="circle-item selected">
          <a href="#">
            <img
              src="category-images/accessories-circle-images/sunglasses.jpg"
              alt="Anklets"
            />
  ...
  <div class="product-grid">
    ...
    $necklaceProducts = $conn->query("SELECT * FROM products WHERE category='Necklace'");
    while ($row = $necklaceProducts->fetch_assoc()): ?>
      ...
      <div class="product-card">
        ...
        <span class="delivery">Free Delivery</span> <!-- static text -->
