...
$result = $conn->query("SELECT * FROM products WHERE category='Bottom Wear'");
?>
<?php
session_start();
...
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <title>Category | BottomWear</title>
...
<section class="sub-nav">
  <a href="#">Category</a> | <a href="#">Bottomwear</a> |
  <a href="#" id="current-category">Skirts</a>
</section>
      ...
      <div class="circle-container">
        <div class="circle-item selected">
          <a href="#">
            <img
              src="category-images/bottomwear-circle-images/skirts.jpg"
              alt="Rings"
            />
            <span>Skirts</span>
          </a>
        ...
        <div class="circle-item selected">
          <a href="#">
            <img
              src="category-images/bottomwear-circle-images/jeans.jpg"
              alt="Necklace"
            />
            <span>Jeans</span>
          </a>
      ...
      <div class="circle-item selected">
          <a href="#">
            <img
              src="category-images/bottomwear-circle-images/shorts.jpg"
              alt="Bracelet"
            />
            <span>Shorts</span>
          </a>
        ...
        <div class="circle-item selected">
          <a href="#">
            <img
              src="category-images/bottomwear-circle-images/trousers.jpg"
              alt="Earrings"
            />
            <span>Trousers</span>
          </a>
        ...
        <div class="circle-item selected">
          <a href="#">
            <img
              src="category-images/bottomwear-circle-images/ethnicbottoms.jpg"
              alt="Anklets"
            />
...
<section class="product-section">  
  <div class="product-grid">
    <?php 
    // Fetch skirts from DB
    $skirtsProducts = $conn->query("SELECT * FROM products WHERE category='Skirts'");
    while ($row = $skirtsProducts->fetch_assoc()): ?>
